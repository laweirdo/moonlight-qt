...
authority: none
read_when:
  - investigating-pre-clean-slate-direction
history_policy: immutable
---
...
**Superseded 14 August 2026 by the clean-slate core-shell direction.** Preserved
only as evidence of the previous design. The root `bulan-creative-brief.md`,
`DESIGN-SYSTEM.md` and `ROADMAP.md` own the current direction.
